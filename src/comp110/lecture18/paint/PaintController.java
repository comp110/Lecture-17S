...
public class PaintController {
    ...
    /**
     * JavaFX will call a Controller's initialize method, if it exists, *after* it binds the View with the Controller.
     */
    public void initialize() {
        _paint = _red.getFill();
        _brush = new CirclesBrush();
        _squaresBrush = new SquaresBrush();
        _circlesMode = true;
    }

    /**
     * The paint method is called every time the mouse is clicked and dragged in the black canvas area.
     */
    public void paint(MouseEvent event) {
        ...
        if (_circlesMode) {
            ...
            _squaresBrush.setFill(_paint);
            _squaresBrush.setSize(_size.getValue());
            shapes = _squaresBrush.shapes();
        }
